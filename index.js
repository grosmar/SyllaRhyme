import dict from './dictionaries/cmudict-0.7b.json' assert { type: "json" };
import flipdict from './dictionaries/flipdict.json' assert { type: "json" };

export let syllarhyme = {
	ipaMappings: {
	/*
	Stress
	Value	Description
...
syllarhyme.dict = dict.map(e => e.split(" "));
syllarhyme.flipdict = flipdict.map(e => e.split(" "));